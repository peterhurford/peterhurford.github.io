...
Motivating people to altruism is relevant for the [optimal philanthropy movement](http://lesswrong.com/lw/6py/optimal_philanthropy_for_human_beings/).  For a start on the answer, like many things, I turn to psychology.  Specifically, the psychology Peter Singer catalogues in his book.<!-- more -->
