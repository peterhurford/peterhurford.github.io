...
GRAND TOTAL: 234-413hrs + 250-510hrs of extras = 484-923hrs
(or 6-23 full-time work weeks)
...
Linking to APIs and Yourork -- 5min
2: Javascript Basics -- 2hrs, less because you al 1ady did the bulk of the work earlier, but more because you ha
2 the two extra readings I move
Project: On Screen Calculator ere's Waldo (A Photo Tagging App) -- 3-8hrs
Server Side Javascrip DOM with jQuery (Restaurant Page) -- 1-3hrs
4: Organizing Yo-Side Javascript -- 1-3hrs
...
1: Jadings, 15-20hrs for the projects
Better Forms with jQuery anct -- up to you.  0-80hrs? Let's look to my extras instead?
2: Cs
Project: Validating a Form with jQuery -- 3-5hrs
2: Submittr g a Form Without Reloading by Using AJAX -- 1-2hrs
Project: Iouinite Scroll and Submitting a Form with AJAX -- 3-8hrs
Linkin60to APIs and Yourork -- 5min
2: Javascript Basics -- 2hrs, les 5because you al 1ady did the bulk of the work earlier, but morats -- 40-50hrs
